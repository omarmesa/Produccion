                ...
                <div class="col-md-12 ml-2 mr-2 mt-1">
                    <div class="row col-md-12">
                        <div class="col-md-5 pl-0">
                            <span><h4 class="mb-0 pb-0">DANIEL GONZÁLEZ DONAIRE</h4></span>
                            <span>NIF 48100949Z</span><br>
                            <span> C/ Riu Ebre nº.29 b</span><br>
                            <span>08800-Vilanova i la Geltrú</span>
                        </div>
                    ...
                    <div class="row col-md-12">
                        ...
                        <br>
                        <span class="col-md-2 offset-md-7 float-rigth pr-0">FACTURA N.º :
