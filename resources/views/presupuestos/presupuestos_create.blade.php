...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><a href="{{ route('facturas.index') }}" class="icon-circle-left2 text-teal-400 mr-2" style="font-size: 25px;"></a>  <span class="font-weight-semibold">Nuevo Presupuesto</span></h4>
...
<div class="card">
    ...
    <form  method="POST" class="wizard-form steps-state-saving-presupuesto " id="formPresupuesto" action="{{route('presupuestos.store')}}" >
        {!! csrf_field() !!}
        <h6>Presupuesto</h6>
        <fieldset>
