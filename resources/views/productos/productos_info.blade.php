...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><a href="{{ route('productos.index') }}" class="icon-circle-left2 text-teal-400 mr-2" style="font-size: 25px;"></a>  <span class="font-weight-semibold">{{$producto->nombre}}</span></h4>
            ...
            <div class="card-body">
                <ul class="media-list">
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                        <div class="media-title font-weight-semibold">SKU:</div>
                    ...
                    <li class="media">
                        ...
                        <div class="media-body">
                        <div class="media-title font-weight-semibold">Stock:</div>
